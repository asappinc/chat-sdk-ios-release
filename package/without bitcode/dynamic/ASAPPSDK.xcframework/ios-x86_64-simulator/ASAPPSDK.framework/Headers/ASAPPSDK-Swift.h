...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull authTokenKey SWIFT_DEPRECATED_MSG("This property will be removed in the next major version.");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull analyticsKey SWIFT_DEPRECATED_MSG("This property will be removed in the next major version.");)
+ (NSString * _Nonnull)analyticsKey SWIFT_WARN_UNUSED_RESULT;
...
+ (void)setUser:(ASAPPUser * _Null_unspecified)newValue;
